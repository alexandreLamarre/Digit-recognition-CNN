...
Exploring a variety of machine learning classification methods using python scientific libraries.
...
Alternativaly, you can just go to the jupyter notebook section of the README.md to see the outputs of the jupyter notebook.
...
- Pumperla, Max, and Kevin Ferguson. "Deep learning and the game of Go." (2019).
